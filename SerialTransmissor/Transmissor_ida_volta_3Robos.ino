      ...
      if (estado == myData.lengthVector){                            // Se o contador de palavras chegar no tamanho da palavra  
        ...
        t1 = t2;                                    // Reseta o timer
         ...
         esp_err_t result = esp_now_send(broadcastAddress, (uint8_t *) &myData, sizeof(myData));
          //Serial.println(v1);
          //Serial.println(v2);
            Serial.write(ReturnData.RD_R[0]);
            Serial.write(ReturnData.RD_R[1]);
            Serial.write(ReturnData2.RD_R[0]);
            Serial.write(ReturnData2.RD_R[1]);
            Serial.write(ReturnData3.RD_R[0]);
            Serial.write(ReturnData3.RD_R[1]);
      }
