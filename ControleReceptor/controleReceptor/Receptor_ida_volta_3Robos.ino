...
uint8_t broadcastAddress[] = {0XE8, 0x31, 0xCD, 0xAC, 0xFE, 0x70};
...
void IRAM_ATTR onTime()
{
  ...
  //Jaocubo
  if(ref_a != (myData.RD[(2*ROBOT +1)])){
    eintegral_a =0;    
  }
  if(ref_a != (myData.RD[(2*ROBOT +2)])){
    eintegral_b =0;
  }
...
{
  if (ROBOT == 1){
    ReturnData.dataAvaliable = true;
    ReturnData.RD_R[0]= vel;
    ReturnData.RD_R[1]= vel_b;
    esp_err_t result = esp_now_send(broadcastAddress, (uint8_t *) &ReturnData, sizeof(ReturnData));
  } else if ( ROBOT == 2){
    ReturnData2.dataAvaliable = true;
    ReturnData2.RD_R[0]= vel;
    ReturnData2.RD_R[1]= vel_b;
    esp_err_t result = esp_now_send(broadcastAddress, (uint8_t *) &ReturnData2, sizeof(ReturnData2));
  } else if (ROBOT == 3){
    ReturnData3.dataAvaliable = true;
    ReturnData3.RD_R[0]= vel;
    ReturnData3.RD_R[1]= vel_b;
    esp_err_t result = esp_now_send(broadcastAddress, (uint8_t *) &ReturnData3, sizeof(ReturnData3));
  }
